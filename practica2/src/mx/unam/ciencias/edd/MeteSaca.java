...
public abstract class MeteSaca<T> {
    ...
    @Override public boolean equals(Object o) {
        ...
        if (getClass() != o.getClass())
            return false;
        @SuppressWarnings("unchecked") MeteSaca<T> red = (MeteSaca<T>)o;
        return equals(this.cabeza,red.cabeza);
    }

    private boolean equals(Nodo prim,Nodo seg){
        ...
        if(prim.elemento.equals(seg.elemento)){
            return equals(prim.siguiente,seg.siguiente);
        }
        return false;
    }
}
