...
public class Lista<T> implements Coleccion<T> {
    ...
    /**
     * Elimina el �ltimo elemento de la lista y lo regresa.
     * @return el �ltimo elemento de la lista antes de eliminarlo.
     * @throws NoSuchElementException si la lista es vac�a.
     */
    ...
    /**
     * Regresa el �ltimo elemento de la lista.
    ...
    public T get(int i) {
        ...
        throw new ExcepcionIndiceInvalido ("Error");
    }
    ...
    private int indiceDe(Object elem, Nodo n, int i){
        if (n==null){
            return -1;
        }
